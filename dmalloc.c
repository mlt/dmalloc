...
#define RUNTIME_FLAGS	(DMALLOC_DEBUG_LOG_STATS | DMALLOC_DEBUG_LOG_NONFREE | \
			 DMALLOC_DEBUG_LOG_BAD_SPACE | \
			 DMALLOC_DEBUG_CHECK_FENCE | \
			 DMALLOC_DEBUG_CATCH_NULL)
#define LOW_FLAGS	(RUNTIME_FLAGS | \
			 DMALLOC_DEBUG_LOG_ELAPSED_TIME | \
			 DMALLOC_DEBUG_CHECK_SHUTDOWN | \
			 DMALLOC_DEBUG_FREE_BLANK | DMALLOC_DEBUG_ERROR_ABORT | \
			 DMALLOC_DEBUG_ALLOC_BLANK)
#define MEDIUM_FLAGS	(LOW_FLAGS | \
			 DMALLOC_DEBUG_CHECK_HEAP | \
			 DMALLOC_DEBUG_REALLOC_COPY)
#define HIGH_FLAGS	(MEDIUM_FLAGS | \
			 DMALLOC_DEBUG_CHECK_BLANK | DMALLOC_DEBUG_CHECK_FUNCS)
